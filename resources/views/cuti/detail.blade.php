...
@section('content')
  ...
  @endif
  <h5>
    <a href="{{route('cuti.index')}}" class="btn btn-outline-secondary btn-sm">
  ...
  <div class="mt-2 py-2">
    ...
    <form class="pt-4" method="POST" action="{{route('pejabat.keputusan.approve')}}">
      ...
      <div class="form-group row border-top pt-2">
        <label for="alasan_pertimbangan" class="col-md-2 col-form-label">Status Keputusan Berwenang</label>
        <div class="col-md-8 col-form-label">
